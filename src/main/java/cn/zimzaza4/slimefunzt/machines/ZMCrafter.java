...
public class ZMCrafter extends AbstractEnergyCrafter {
    ...
    public ZMCrafter(Category category, SlimefunItemStack item, RecipeType type, ItemStack[] recipe, int energy) {
    ...
    public void setupMenu(@Nonnull BlockMenuPreset blockMenuPreset) {
        ...
        blockMenuPreset.addItem(RECIPE_SLOT, new CustomItem(Material.BOOK, "&6灵魂处理"),
