...
public class SCArmorCrafter extends AbstractEnergyCrafter {
    ...
    public static final RecipeType TYPE = new RecipeType(
            new NamespacedKey(SlimefunZT.getInstance(), "ZIM_ARMOR_WORKBENCH"), Items.ArmorCrafter, (stacks, stack) -> {
    ...
    public void setupMenu(@Nonnull BlockMenuPreset blockMenuPreset) {
        ...
        blockMenuPreset.addItem(RECIPE_SLOT, new CustomItem(Material.BOOK, "&a工作台"),
