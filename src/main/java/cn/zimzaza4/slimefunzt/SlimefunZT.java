...
import cn.zimzaza4.slimefunzt.Listener.EliteMobD;
import cn.zimzaza4.slimefunzt.Listener.onClickMac;
...
public class SlimefunZT extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable(){
        ...
        Bukkit.getPluginManager().registerEvents(new onClickMac(), this);
    }
